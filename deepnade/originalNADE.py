...
def get_parser():
    ...
    parser.add_option("--n_components", dest="n_components",
                      default=10, type="int")  # number of GMM components
    ...
    parser.add_option("--lr", dest="lr", default=0.01, type="float")  # learning rate
    parser.add_option("--decrease_constant", dest="decrease_constant",
                      default=0.1, type="float")
    parser.add_option("--wd", dest="wd", default=0.00, type="float")  # weight decay
...
def train_NADE(options, args):
    ...
    # used to say NAGSGD but this no longer exists
    ...
    trainer.add_controller(TrainingController.MontrealLearningRate(
        options.lr, options.decrease_constant))
    # trainer.add_controller(TrainingController.(options.lr, 0, epochs=options.epochs))
